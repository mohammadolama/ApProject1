...
public class Player implements Serializable {
    ...
    public Player(String username, String password) throws IOException {
        ...
        this.setId(st1);
        String st = String.format("players\\%s-%s.log", username, this.getId());
    ...
    void SetFirstHero(Player player) throws IOException {
        ...
        if (player.getNewToGame() == true) {
            while (flag) {
                ...
                System.out.println(ConsoleColors.CYAN_BOLD + "Mage" + ConsoleColors.RED_BOLD_BRIGHT + "     Rouge" + ConsoleColors.GREEN_BOLD + "       Warlock" + ConsoleColors.RESET);
                ...
                switch (hero) {
                    ...
                    case "rouge":
                        ...
                        player.setSelectedHero(JsonReaders.HeroJsonReader(player,"rouge"));flag=false;
                        break;
                    case "warlock":
