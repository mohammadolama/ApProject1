...
//            if (hero.equalsIgnoreCase("mage") || hero.equalsIgnoreCase("rogue") || hero.equalsIgnoreCase("warlock")) {
//                if (player.getPlayerHeroes().contains(Heroes.valueOf(hero))) {
//                    JsonBuilders.HeroBuilder(player, player.getSelectedDeck().getHero());
//                    switch (hero) {
//                        case "mage":
...
//                            break;
//                        case "rogue":
//                            player.setSelectedHero(JsonReaders.HeroJsonReader(player, "rogue"));
//                            flag = false;
//                            break;
//                        case "warlock":
...
//    }
    ...
    static void HeroAdder(Player player) {
        ...
        if (ar.contains(Heroes.rogue) == false)
            ar.add(Heroes.rogue);
